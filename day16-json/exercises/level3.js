...
let userWithManySkills = keys[0]
for(let key of keys){
    if(textObject[key].skills.length > textObject[userWithManySkills].skills.length){
        userWithManySkills = key
    }
}
